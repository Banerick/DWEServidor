<?php
/**
 * Plugin name: ATAlgaba Plugin
 * Author:      Antonio Terrero Algaba
 * Description: Personalización del sitio web
 */
...
function ata_ic_initialize_divi_modules()
{
    ...
    class ATA_Builder_Module_Image_Caption extends ET_Builder_Module
    {
        function init()
        {
            $this->name = esc_html__('Image Caption', 'ata_ic');
            $this->slug = 'et_pb_image_caption';
        ...
        function shortcode_callback($atts, $content = null, $function_name)
        {
            ...
            $is_overlay_applied = ('on' === $show_in_lightbox || ('off' === $show_in_lightbox && '' !== $url)) ? 'on' : 'off';
    ...
    new ATA_Builder_Module_Image_Caption;
